...
VERSION = "1.10"  # keep in sync with the latest GitHub release tag
...
<div class="app">
  ...
  <div class="panel" id="todo">{warn_html}{todo}</div>
    ...
    <div class="panel" id="settings">
      ...
      <div class="setgroup">
        <h2>Export for AI</h2>
        <p class="sd" style="margin:0 0 10px">Your data as JSON, with a prompt ready to paste into any AI.</p>
