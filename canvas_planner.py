...
VERSION = "1.5"  # keep in sync with the latest GitHub release tag
...
def reauth_prompt(cfg):
    ...
    print("\n⚠️  Your Canvas access token expired or was revoked.")
  ...
  <div class="panel" id="todo">{warn_html}{todo}</div>
    ...
    <div class="panel" id="settings">
      ...
      <div class="setgroup">
        ...
        <div class="setrow" id="icsFeedRow" style="display:none"><div><div class="st">Live calendar feed</div><div class="sd">Subscribe once and your deadlines stay in sync while Semester is running — Apple Calendar: File → New Calendar Subscription; Google Calendar: Other calendars → From URL.<span class="feedurl" id="icsFeedUrl"></span></div></div>
