...
1. Download your platform from [**Releases**](https://github.com/LED-esma/semester/releases):
   - **Mac** — `Semester-mac.dmg` (signed & notarized — open it and drag Semester into Applications)
...
2. Open it and follow the short setup:
   - **Find your school.** Paste any Canvas link, or just type your school's Canvas name. It checks right away.
   - **Connect your account.** Semester opens your Canvas settings. Click **+ New Access Token**, name it
     Semester, leave the expiry date blank, and paste the token back. It connects the moment you paste.
   - **Make it yours.** Pick light, dark, or auto, an accent color, and whether you want reminders.
     Your courses load in the background while you choose.
3. Click **Open Semester**. Your dashboard is ready.

## Using it day to day

- Open the app. Your dashboard shows right away and stays current on its own: Semester checks Canvas for changes every few minutes and whenever you come back to it.
...
- **Classes** shows each course like Google Classroom; **Settings** has themes, sections,
  calendar export, reminders, and updates.
...
- On a Mac running 1.7 or earlier, download 1.8 once from Releases. Older Mac builds couldn't
  reach GitHub to check for updates (and 1.5 and earlier could unpack an update incorrectly).
  From 1.8 on, updates are one click.
