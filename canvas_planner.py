...
VERSION = "1.9"  # keep in sync with the latest GitHub release tag
...
<div class="app">
  ...
  <div class="panel" id="todo">{warn_html}{todo}</div>
    ...
    <div class="foot">Green start dates are the suggested days to begin so you're not cramming. Colored dots group by course. Click any card to read its description.</div>
  </main>
</div>
