...
VERSION = "1.20"  # keep in sync with the latest GitHub release tag
  ...
  <div class="panel" id="todo">{warn_html}{todo}</div>
    ...
    <div class="panel" id="settings">
      ...
      <div class="setgroup">
        ...
        <div class="setrow" id="nWhenRow"><div class="st">Remind me</div>
          <div class="checks"><label><input type="checkbox" data-when="day_before"> The day before</label>
            <label><input type="checkbox" data-when="morning"> The morning it's due</label>
            <label><input type="checkbox" data-when="hours3"> 3 hours before</label></div></div>
        <div class="setrow"><div><div class="st">New assignments, announcements, and grades</div><div class="sd">A heads-up when something new shows up in Canvas.</div></div>
          <label class="switch"><input type="checkbox" id="nNew"><span class="track"></span></label></div>
